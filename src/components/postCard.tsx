...
const {id,title,body}=props
    return (
        <div className="p-2 border-b-1 border-gray-700 flex gap-x-4 mt-5 border rounded md:hover:scale-110 transition delay-75 duration-100 cursor-pointer items-center">
